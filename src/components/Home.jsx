    ...
    <motion.main className="flex justify-center max-w-[100vw]" exit={{ opacity: 0 }}>
      ...
      <div className="w-full max-w-[1440px]">
        ...
        <div className="relative">
          <BgAnimation />
          <motion.section className="px-[3rem] mb-30 relative" >
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-[repeat(4,_minmax(200px,_310px))] gap-8 gap-y-14 mb-14 relative z-10">
